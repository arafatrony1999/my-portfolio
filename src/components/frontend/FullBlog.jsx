                ...
                <div className='w-100'>
                    ...
                    <div className="social-buttons my-4">
                        <div className="products-others-right">
                            ...
                            <Link to={twitterShareUrl} style={{background: "#0087BA"}}><BsTwitter /></Link>
                            <Link to={facebookShareUrl} style={{background: "#2D4373"}}><FaFacebookF /></Link>
                            <Link to={linkedinShareUrl} style={{background: "#005983"}}><FaLinkedinIn /></Link>
                            <Link to={whatsappShareUrl} style={{background: "#1F7D1E"}}><BsWhatsapp /></Link>
                        </div>
                    </div>
